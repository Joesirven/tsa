...
class TestCreatePlanEndpoint:
    ...
    async def test_create_plan_success(
        ...
        plan_input = PlansIn(
            ...
            end_of_budget="2023-09-30",
            trip_start_date="2023-10-01",
            trip_end_date="2023-10-15",
        ...
        created_plan = await create_plan(
            ...
            mock_plans_repo_instance,
            mock_savings_repo_instance,
            mock_transactions_repo_instance,
        )
